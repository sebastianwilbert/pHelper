...
# Variable_Options
variables = tk.Menubutton(root, text="Choose What is Known", foreground="#000000", activeforeground="#000000",
                          font=("Trebuchet MS", 12))
...
i_pka = tk.IntVar()
i_pkb = tk.IntVar()
variables_opt = tk.Menu(variables, tearoff=0, font=("Trebuchet MS", 12))
...
variables_opt.entryconfig("pKb", state="disabled")
# Calculation_Options
calculate = tk.Menubutton(root, text="Choose What to Calculate", foreground="#000000", activeforeground="#000000",
                          font=("Trebuchet MS", 12))
...
pka_i = tk.IntVar()
pkb_i = tk.IntVar()
calculate_opt = tk.Menu(calculate, tearoff=0, font=("Trebuchet MS", 12))
...
# PH
ph_label = tk.Label(first_frame, text="pH", bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
s_ph = tk.StringVar()
ph = tk.Entry(first_frame, highlightthickness=0, textvariable=s_ph, width=10, bg="#C5DFF8", fg="#000000",
...
ph_dis = tk.Label(second_frame, bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
# POH
poh_label = tk.Label(first_frame, text="pOH", bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
s_poh = tk.StringVar()
poh = tk.Entry(first_frame, highlightthickness=0, textvariable=s_poh, width=10, bg="#C5DFF8", fg="#000000",
               relief="ridge", font=("Trebuchet MS", 12))
...
poh_dis = tk.Label(second_frame, bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
# [H+]
h_molarity_label = tk.Label(first_frame, text="[H+]", bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
...
h_molarity = tk.Entry(first_frame, highlightthickness=0, textvariable=s_h_molarity, width=10, bg="#C5DFF8",
                      fg="#000000", relief="ridge", font=("Trebuchet MS", 12))
...
h_molarity_dis = tk.Label(second_frame, bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))

# [OH-]
oh_molarity_label = tk.Label(first_frame, text="[OH-]", bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
...
oh_molarity_dis = tk.Label(second_frame, bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
# [Salt]
salt_molarity_label = tk.Label(first_frame, text="[Salt]", bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
...
salt_molarity_dis = tk.Label(second_frame, bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
# Ka
ka_label = tk.Label(first_frame, text="Ka", bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
s_ka = tk.StringVar()
ka = tk.Entry(first_frame, highlightthickness=0, textvariable=s_ka, width=10, bg="#C5DFF8", fg="#000000",
              relief="ridge", font=("Trebuchet MS", 12))
...
ka_dis = tk.Label(second_frame, bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
# Kb
kb_label = tk.Label(first_frame, text="Kb", bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
s_kb = tk.StringVar()
kb = tk.Entry(first_frame, highlightthickness=0, textvariable=s_kb, width=10, bg="#C5DFF8", fg="#000000",
              relief="ridge", font=("Trebuchet MS", 12))
...
kb_dis = tk.Label(second_frame, bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
# PKa
pka_label = tk.Label(first_frame, text="pKa", bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
s_pka = tk.StringVar()
pka = tk.Entry(first_frame, highlightthickness=0, textvariable=s_pka, width=10, bg="#C5DFF8", fg="#000000",
               relief="ridge", font=("Trebuchet MS", 12))
...
pka_dis = tk.Label(second_frame, bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
# PKb
pkb_label = tk.Label(first_frame, text="pKb", bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
s_pkb = tk.StringVar()
pkb = tk.Entry(first_frame, highlightthickness=0, textvariable=s_pkb, width=10, bg="#C5DFF8", fg="#000000",
               relief="ridge", font=("Trebuchet MS", 12))
...
pkb_dis = tk.Label(second_frame, bg="#91D8E4", fg="#000000", font=("Trebuchet MS", 12))
# Result_Label
